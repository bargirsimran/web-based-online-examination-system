    ...
    <div>
      ...
      <div class="lg:p-12 max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
        <form action="" method="post" id="login_form" class="lg:p-10 p-6 space-y-3 relative bg-white shadow-xl rounded-md">
          <h1 class="lg:text-2xl text-xl font-semibold mb-6">Student Login</h1>
          <hr>
          ...
          <div>
            ...
            <input type="text" id="username" name="username" placeholder="Username" class="bg-gray-100 h-12 mt-2 px-3 rounded-md w-full" value="<?php if (isset($_COOKIE["eusername0"])) {
                                                                                                                                                  echo $_COOKIE["eusername0"];
                                                                                                                                                } ?>">
          </div>
          <div>
            <label class="mb-0" for="password"> Password </label>
            <input type="password" id="password" name="password" placeholder="******" class="bg-gray-100 h-12 mt-2 px-3 rounded-md w-full" value="<?php if (isset($_COOKIE["epass0"])) {
                                                                                                                                                    echo $_COOKIE["epass0"];
                                                                                                                                                  } ?>">
          </div>
  
          <div class="checkbox mt-8">
            <input type="checkbox" id="chekcbox1" name="rem_me" <?php if (isset($_COOKIE["eusername0"])) {
                                                    echo "checked";
                                                  } ?>>
